 ...
 * @method \App\Model\Entity\RoleAcces newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\RoleAcces[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\RoleAcces|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\RoleAcces[] patchEntities($entities, array $data, array $options = [])
