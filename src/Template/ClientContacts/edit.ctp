...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="page-title">CLIENT MANAGER
            <small>[ Edit Client Manager ]</small>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 margintop3">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('email', ['readonly' => true, 'label'=>false, 'type'=>'email', 'value' => $user->email, 'placeholder'=>'Enter Valid Email Id','class'=>'input-sm bg-gray form-control','autocomplete'=>'off']); ?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('first_name', ['label'=>false, 'value' => $user->first_name, 'placeholder'=>'First Name','class'=>'form-control input-sm bg-gray','autocomplete'=>'off']); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">Middle Name</label>
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('middle_name', ['label'=>false, 'value' => $user->middle_name, 'class' => 'form-control input-sm bg-gray','placeholder'=>'Middle Name','autocomplete'=>'off']); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('last_name', ['label'=>false, 'value' => $user->last_name, 'class' => 'form-control input-sm bg-gray','placeholder'=>'Last Name','autocomplete'=>'off']); ?>
                    </div>
                </div>
                <div class="row">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
                    ...
                    <div class="form-group col-md-2 col-lg-2 col-xs-12 col-sm-3">
                        <?php echo $this->Form->control('contact_country_code', ['label'=>false, 'value' => $user->contact_country_code, 'empty'=>'Code','options'=>array('001'=>'001','0091'=>'0091'),'class'=>'input-sm bg-gray form-control']);?>
                    </div>
                    <div class="form-group col-md-6 col-sm-6 col-xs-12 col-lg-6">
                        <?php echo $this->Form->control('contact_number', ['label'=>false, 'value' => $user->contact_number, 'maxlength'=>'12', 'class' => 'bg-gray form-control input-sm','placeholder'=>'Max 12 digits only']); ?>
                    </div>
                </div>
                <!-- <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="panel widget">
                            ...
                            <?= $this->Html->image('user-profile-pic/'.$user->profile_pic, ['id' => 'blah', 'height' => '150']) ?>
