...
<div class="row">
    <div class="col-md-12">
        <div class="page-title">JOB <small>Edit Job</small>
    ...
    <div class="panel-body">
        <div class="row form-group">
            <div class="col-lg-12 col-sm-12 col-md-9 col-xs-12">
                <label class="text-center">Job Title</label>
        ...
        <div class="form-group row">
            <div class="col-lg-12 col-sm-12">
                <button class="btn btn-sm btn-success  pull-right" type="submit" id="submitBtn" title="Save">
