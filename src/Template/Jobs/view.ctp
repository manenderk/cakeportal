    ...
    <div class="col-md-12">
        <div class="page-title">JOB TITLE
            <span class="pull-right short-ico">
                ...
                <a href="<?php echo $this->Url->build(["controller" => "jobs", "action" => "edit",$job->id]); ?>"
                    title="Edit">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p class="m0"><?= $this->Text->autoParagraph(h($job->description)); ?>
                            </p>
                        </div>
                    </div>
                </div>
