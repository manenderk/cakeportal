    ...
    <div class="col-md-12">
        <div class="page-title">PROFILE SOURCE
            <span class="pull-right short-ico">
                ...
                <a
                    href="<?php echo $this->Url->build(["controller" => "profileSource", "action" => "edit", $profileSource->id]); ?>">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="text-md">Profile Source Name</div>
                            <p class="m0"><?= h($profileSource->title) ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p class="m0"><?= h($profileSource->description) ?>
                            </p>
                        </div>
                    </div>
                </div>
