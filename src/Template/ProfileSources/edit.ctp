...
<div class="row">
    <div class="col-md-12">
        <div class="page-title">PROFILE SOURCE <small>Edit Profile Source</small>
...
<script>
    $(document).ready(function() {
        $("#title").blur(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?=$this->Url->build(["controller" => "ProfileSources","action" => "check-source-name", $profileSource->id]);?>",
                data: dataString,
                cache: false,
                headers: {
