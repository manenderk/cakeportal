    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('client_manager_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('email') ?></th>
                <th scope="col"><?= $this->Paginator->sort('description') ?></th>
                <th scope="col"><?= $this->Paginator->sort('status') ?></th>
                <th scope="col"><?= $this->Paginator->sort('is_contract_signed') ?></th>
                <th scope="col"><?= $this->Paginator->sort('contract_expiry_date') ?></th>
                <th scope="col"><?= $this->Paginator->sort('client_logo') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($client->is_contract_signed) ?></td>
