    ...
    <div class="col-md-12">
        <div class="page-title">RATE TYPE
            <span class="pull-right short-ico">
                ...
                <a
                    href="<?php echo $this->Url->build(["controller" => "rateTypes", "action" => "edit",$rateType->id]); ?>">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="text-md">Rate Type Name</div>
                            <p class="m0"><?= h($rateType->name) ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p class="m0"><?= h($rateType->description) ?>
                            </p>
                        </div>
                    </div>
                </div>
