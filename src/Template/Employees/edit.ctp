        ...
        <div class="row">
            ...
            <section>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('reporting_manager', ['label'=>false, 'options' => $userOptions,'class'=>'input-sm bg-gray form-control','empty'=>'Select Reporting Manager', 'required'=>true]); ?>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
            ...
            <section>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('hire_date', ['type' => 'text', 'placeholder' => 'Select Hire Date', 'label'=>false,'class'=>'input-sm bg-gray form-control', 'required' => true, 'value' => $employee->hire_date->i18nFormat('yyyy-MM-dd')]); ?>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">Termination Date</label>
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('termination_date', ['type' => 'text', 'placeholder' => 'Select Termination Date','label'=>false,'class'=>'input-sm bg-gray form-control', 'value' => $employee->termination_date->i18nFormat('yyyy-MM-dd')]); ?>
                    </div>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
                        <span class="text-danger">*</span>Salary</label>
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('salary', ['label'=>false ,'class'=>'input-sm bg-gray form-control','empty'=>'Enter Salary', 'required' => true]); ?>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('dob', ['type' => 'text', 'placeholder' => 'Select Date of birth', 'label'=>false,'class'=>'input-sm bg-gray form-control', 'required' => true, 'value' => $employee->dob->i18nFormat('yyyy-MM-dd')]); ?>
                    </div>
                </div>
                <div class="form-group col-md-6">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
            ...
            <section>
                ...
                <div class="form-group col-md-6">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">Emergency Contact Person Contact Number 2</label>
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        ...
                        if ($field['type'] == 'select') {
                            ...
                            $field['choices'], 'label' => false, 'class'=>'input-sm bg-gray form-control', 'empty'=>'Select '.$field['name'], 'value' => $field['value']]);
                        } else {
                            echo $this->Form->control('customField['.$field['id'].']', ['type'=>$field['type'], 'label' =>
                            false, 'class'=>'input-sm bg-gray form-control', 'placeholder' => 'Enter '.$field['name'], 'value' => $field['value']]);
                        }
                        ?>
                    </div>
                </div>
